...
public class GuildTicketsRecord extends TableRecordImpl<GuildTicketsRecord> implements Record7<Long, Long, Long, Long, String, Boolean, JSON> {
    ...
    @Override
    public Row7<Long, Long, Long, Long, String, Boolean, JSON> valuesRow() {
    ...
    @Override
    public GuildTicketsRecord values(Long value1, Long value2, Long value3, Long value4, String value5, Boolean value6, JSON value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GuildTicketsRecord(Long guildId, Long channelId, Long categoryId, Long creatorId, String ticketTimestamp, Boolean open, JSON transcript) {
        super(GuildTickets.GUILD_TICKETS);
