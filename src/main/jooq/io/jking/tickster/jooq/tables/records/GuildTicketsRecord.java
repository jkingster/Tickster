...
public class GuildTicketsRecord extends UpdatableRecordImpl<GuildTicketsRecord> implements Record8<Integer, Long, Long, Long, Long, String, Boolean, JSON> {
    ...
    @Override
    public Row8<Integer, Long, Long, Long, Long, String, Boolean, JSON> valuesRow() {
    ...
    @Override
    public GuildTicketsRecord value7(Boolean value) {
        setOpen(value);
        return this;
    }

    @Override
    public GuildTicketsRecord value8(JSON value) {
        setTranscript(value);
        return this;
    }

    @Override
    public GuildTicketsRecord values(Integer value1, Long value2, Long value3, Long value4, Long value5, String value6, Boolean value7, JSON value8) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public GuildTicketsRecord(Integer id, Long guildId, Long channelId, Long categoryId, Long creatorId, String ticketTimestamp, Boolean open, JSON transcript) {
        super(GuildTickets.GUILD_TICKETS);
