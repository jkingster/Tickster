...
public class GuildData extends TableImpl<GuildDataRecord> {
    ...
    /**
     * The column <code>public.guild_data.invite_channel_id</code>.
     */
    public final TableField<GuildDataRecord, Long> INVITE_CHANNEL_ID = createField(DSL.name("invite_channel_id"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field("0", SQLDataType.BIGINT)), this, "");

    /**
     * The column <code>public.guild_data.log_channel_id</code>.
     */
    public final TableField<GuildDataRecord, Long> LOG_CHANNEL_ID = createField(DSL.name("log_channel_id"), SQLDataType.BIGINT.nullable(false).defaultValue(DSL.field("0", SQLDataType.BIGINT)), this, "");
